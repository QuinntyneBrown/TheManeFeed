    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Color", "DisplayOrder", "Name", "Slug" },
                values: new object[,]
                {
                    { 1, "#C85A7C", 1, "Color Trends", "color" },
                    { 2, "#C9A96E", 2, "Celebrity Hair", "celebrity" },
                    { 3, "#8B7D6B", 3, "Haircuts & Styles", "cuts" },
                    { 4, "#D4A0A7", 4, "Hair Care", "care" },
                    { 5, "#1A1A1A", 5, "Products & Reviews", "products" },
                    { 6, "#C9A96E", 6, "Salon Guide", "salon" },
                    { 7, "#8B7D6B", 7, "Styling", "styling" },
                    { 8, "#C85A7C", 8, "Trending", "trending" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrendingSearches_SearchCount",
